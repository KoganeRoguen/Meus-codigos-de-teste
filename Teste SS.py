...
class MoneySimulator:
    def __init__(self, master):
        ...
        self.progressbar = ttk.Progressbar(master, length=200)
    ...
    def update_progress(self):
        ...
        self.progressbar['value'] = self.progress_value
        if self.progress_value < 30:  # 30 segundos
            ...
            self.progressbar.pack_forget()  # Remove a barra de progresso após 30 segundos
